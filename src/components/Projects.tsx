...
import { Github, ExternalLink, Star, Calendar, Users, Code, Heart, Zap, Target, Award, X } from 'lucide-react';
  ...
  const projects: Project[] = [
    {
      ...
      description: 'A point-based behavioral management system with collaborative filtering algorithms to recommend improvement actions for low-performing students. Features multi-level dashboards for superadmin, teachers, and students with real-time point tracking.',
      image: student_progress,
      technologies: ['React', 'Node.js', 'Express.js', 'PostgreSQL', 'Tailwind CSS', 'Redux', 'JWT'],
      features: [
    ...
    },
    {
      ...
      description: 'Comprehensive tournament platform with online registration, team management, and innovative opponent matching system to connect players with suitable competitors.',
      image: football,
      technologies: ['React', 'Node.js', 'Express.js', 'MongoDB', 'Tailwind CSS', 'Redux', 'JWT'],
      features: [
    ...
    },
    {
      ...
      description: 'Interactive e-learning platform with course management, video streaming, and digital content delivery for both students and educators.',
      image: 'https://images.pexels.com/photos/4145153/pexels-photo-4145153.jpeg',
      technologies: ['React', 'Node.js', 'Express.js', 'MongoDB', 'Cloudinary', 'Multer', 'Tailwind CSS'],
      features: [
    ...
    },
    {
      ...
      description: 'Bespoke tailoring solution allowing customers to select fabrics, submit measurements, and order custom-fitted clothing through an intuitive online interface.',
      image: fitness,
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {project.features.slice(0, 4).map((feature) => (
                      <div key={feature} className="flex items-start space-x-3 text-base text-gray-300">
        ...
        <div className="bg-gray-800 rounded-2xl p-10 border border-gray-700 hover:border-cyan-400/50 transition-all duration-300 mb-16">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-white mb-4">
              Development <span className="bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">Principles</span>
            </h3>
            <p className="text-lg text-gray-400">The core values that guide my technical approach</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {principles.map((principle) => (
              ...
              >
                ...
                <p className="text-base text-gray-400">{principle.description}</p>
              </div>
            ))}
          </div>
        </div>
