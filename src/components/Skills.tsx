          ...
          {skillCategories.map((category) => (
            ...
            >
              <div className="flex items-center mb-8">
                <div
                  className={`inline-flex items-center justify-center w-12 h-12 rounded-lg bg-gradient-to-r ${category.color} mr-4 group-hover:scale-110 transition-transform duration-300`}
                >
                  {category.icon}
                </div>
        ...
        <div className="bg-gray-800 rounded-2xl p-10 border border-gray-700 hover:border-cyan-400/50 transition-all duration-300 mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-400">
              Milestones that demonstrate my expertise and dedication
            </p>
          </div>
