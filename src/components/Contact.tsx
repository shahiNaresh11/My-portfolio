          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-8">
                ...
                projects, or just chat about technology. Whether you have a
                project in mind or want to explore possibilities, I'd love to
                hear from you.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {contactInfo.map((info, index) => (
                ...
                >
                  <div
                    className={`inline-flex items-center justify-center w-12 h-12 rounded-lg bg-gradient-to-r ${info.color} mb-4 group-hover:scale-110 transition-transform duration-300`}
                  >
