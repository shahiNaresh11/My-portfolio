...
const Hero: React.FC<HeroProps> = ({ scrollToSection }) => {
  ...
  const handleDownloadCV = () => {
    ...
    link.href = "/Naresh-Thakuri-CV.pdf"; // Path to your CV in public folder
    link.download = "Naresh-Thakuri-CV.pdf"; // The filename for the downloaded file
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-pink-500 rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-pulse"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="animate-fade-in-up">
          ...
          <p className="text-lg sm:text-xl text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed">
            Passionate MERN Stack Developer with experience in building scalable
            web applications. I transform ideas into powerful digital solutions
          ...
          <div className="flex flex-wrap justify-center gap-8 mb-12">
            ...
            <div className="flex items-center space-x-2 text-gray-300">
              <span className="w-6 h-6 bg-cyan-500 rounded-full flex items-center justify-center text-sm text-white font-bold">
                7+
              </span>
